...
export const PARENT_COLLECTION_ID = Bytes.fromHexString("0x0") as Bytes;
...
export function tokenIndexId(conditionId: Bytes, index: i32): Bytes {
  return Bytes.fromHexString(
    conditionId.toHex().concat("-").concat(index.toString())
  );
}
