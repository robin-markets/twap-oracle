...
const P = BigInt.fromString('21888242871839275222246405745257275088696311157297823662689037894645226208583');
...
// a^((P-1)/2) mod P
const legendreSymbol = (a: BigInt): BigInt => powModP(a, P.minus(BigInt.fromI32(1)).rightShift(1));
...
const computeCollectionId = (conditionId: Bytes, outcomeIndex: u8): Bytes => {
 ...
 * @returns
 */
const computePositionIdFromCollectionId = (collateral: Address, collectionId: Bytes): BigInt => {
...
const computePositionId = (collateral: Address, conditionId: Bytes, outcomeIndex: u8): BigInt => {
